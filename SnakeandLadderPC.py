...
def start():
    ...
    for i in range(1,100):
        tile = tk.Button(root, bg="white", text=i, height=2, width=4, font=('Arial', 12))
    ...
    def roll():
        ...
        dicebutton.place(x=250, y=555, height=50, width=50)
    ...
    rollbutton.place(x=150, y=560, height=40, width=70)


startbutton = tk.Button(root, text="Start", command=start)
startbutton.place(x=170, y=150, height=60, width=100)
root.mainloop()
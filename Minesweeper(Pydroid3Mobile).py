...
#tile two
    ...
    if score > 20:
        event()
    scorelabel = tk.Label(root,bg="white", text=f"Tiles cleared: {score} ")
...
def start():
    ...
    a1 = tk.Button(root, bg="gray",command=lambda: paint(1))
    a1.place(x=50, y=200, height=200, width=200)
    a2 = tk.Button(root, bg="gray", command=lambda: paint(2))
    a2.place(x=50, y=400, height=200, width=200)
    a3 = tk.Button(root, bg="gray", command=lambda: paint(3))
    a3.place(x=50, y=600, height=200, width=200)
    a4 = tk.Button(root, bg="gray", command=lambda: paint(4))
    a4.place(x=50, y=800, height=200, width=200)
    a5 = tk.Button(root, bg="gray", command=lambda: paint(5))
    a5.place(x=50, y=1000, height=200, width=200)
    b1 = tk.Button(root, bg="gray", command=lambda: paint(6))
    b1.place(x=250, y=200, height=200, width=200)
    b2 = tk.Button(root, bg="gray", command=lambda: paint(7))
    b2.place(x=250, y=400, height=200, width=200)
    b3 = tk.Button(root, bg="gray", command=lambda: paint(8))
    b3.place(x=250, y=600, height=200, width=200)
    b4 = tk.Button(root, bg="gray", command=lambda: paint(9))
    b4.place(x=250, y=800, height=200, width=200)
    b5 = tk.Button(root, bg="gray", command=lambda: paint(10))
    b5.place(x=250, y=1000, height=200, width=200)
    c1 = tk.Button(root, bg="gray", command=lambda: paint(11))
    c1.place(x=450, y=200, height=200, width=200)
    c2 = tk.Button(root, bg="gray", command=lambda: paint(12))
    c2.place(x=450, y=400, height=200, width=200)
    c3 = tk.Button(root, bg="gray", command=lambda: paint(13))
    c3.place(x=450, y=600, height=200, width=200)
    c4 = tk.Button(root, bg="gray", command=lambda: paint(14))
    c4.place(x=450, y=800, height=200, width=200)
    c5 = tk.Button(root, bg="gray", command=lambda: paint(15))
    c5.place(x=450, y=1000, height=200, width=200)
    d1 = tk.Button(root, bg="gray", command=lambda: paint(16))
    d1.place(x=650, y=200, height=200, width=200)
    d2 = tk.Button(root, bg="gray", command=lambda: paint(17))
    d2.place(x=650, y=400, height=200, width=200)
    d3 = tk.Button(root, bg="gray", command=lambda: paint(18))
    d3.place(x=650, y=600, height=200, width=200)
    d4 = tk.Button(root, bg="gray", command=lambda: paint(19))
    d4.place(x=650, y=800, height=200, width=200)
    d5 = tk.Button(root, bg="gray", command=lambda: paint(20))
    d5.place(x=650, y=1000, height=200, width=200)
    e1 = tk.Button(root, bg="gray",command=lambda: paint(21))
    e1.place(x=850, y=200, height=200, width=200)
    e2 = tk.Button(root, bg="gray", command=lambda: paint(22))
    e2.place(x=850, y=400, height=200, width=200)
    e3 = tk.Button(root, bg="gray", command=lambda: paint(23))
    e3.place(x=850, y=600, height=200, width=200)
    e4 = tk.Button(root, bg="gray", command=lambda: paint(24))
    e4.place(x=850, y=800, height=200, width=200)
    e5 = tk.Button(root, bg="gray", command=lambda: paint(25))
    e5.place(x=850, y=1000, height=200, width=200)
...
startbt.place(x=400, y=600, height=150, width=300)

...
position,car1pos,car2pos = 5,11,13
...
def Start():
    ...
    ###MOVING CARS#####
    def car1():
        global car1pos,car2pos
        car1pos = car1pos + 1
        car2pos = car2pos + 1
        print(car1pos)
        root.after(1000, car1)
        if car1pos in carloop:
            car1pos = carloop[car1pos]
            print(f"position two:{car1pos}")
